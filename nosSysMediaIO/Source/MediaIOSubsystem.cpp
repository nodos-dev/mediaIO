...
nosResult NOSAPI_CALL Get2DFrameResolution(nosMediaIOFrameGeometry geom, nosVec2u* outResolution)
{
	...
	static const std::unordered_map<nosMediaIOFrameGeometry, nosVec2u> frameGeometryTable = {
		{NOS_MEDIAIO_FG_NTSC, {720, 486}},
		{NOS_MEDIAIO_FG_PAL, {720, 576}},
		{NOS_MEDIAIO_FG_HD720, {1280, 720}},
		{NOS_MEDIAIO_FG_HD1080, {1920, 1080}},
		{NOS_MEDIAIO_FG_2K, {2048, 1080}},
		{NOS_MEDIAIO_FG_2KDCI, {2048, 1080}},
		{NOS_MEDIAIO_FG_4K2160, {3840, 2160}},
		{NOS_MEDIAIO_FG_4KDCI, {4096, 2160}},
		{NOS_MEDIAIO_FG_8K4320, {7680, 4320}},
		{NOS_MEDIAIO_FG_8KDCI, {8192, 4320}},
		{NOS_MEDIAIO_FG_640x480, {640, 480}},
		{NOS_MEDIAIO_FG_800x600, {800, 600}},
		{NOS_MEDIAIO_FG_1440x900, {1440, 900}},
		{NOS_MEDIAIO_FG_1440x1080, {1440, 1080}},
		{NOS_MEDIAIO_FG_1600x1200, {1600, 1200}},
		{NOS_MEDIAIO_FG_1920x1200, {1920, 1200}},
		{NOS_MEDIAIO_FG_1920x1440, {1920, 1440}},
		{NOS_MEDIAIO_FG_2560x1440, {2560, 1440}},
		{NOS_MEDIAIO_FG_2560x1600, {2560, 1600}}
	};
